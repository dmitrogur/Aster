...
SDRPP_MOD_INFO{
    ...
    /* Description:     */ "Spectran V6 HTTP source module for Aster",
    /* Author:          */ "Ryzerth",
    /* Version:         */ 0, 1, 0,
    /* Max instances    */ 1
};
...
private:
    ...
    static void menuHandler(void* ctx) {
        ...
        SmGui::FillWidth();
        if (!connected && SmGui::Button("З'єднати##spectran_http_source")) {
            _this->tryConnect();
        }
        else if (connected && SmGui::Button("Відключити##spectran_http_source")) {
