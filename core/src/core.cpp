...
int sdrpp_main(int argc, char* argv[]) {
    ...
    defConfig["InstanceName"] =  "TestInstance";
    defConfig["Url"] = "http://localhost:18101/event";
    ...
    defConfig["menuElements"][0]["name"] = "Радіоприймач";
    ...
    defConfig["menuElements"][4]["name"] = "Колір каналу приймання";
    defConfig["menuElements"][4]["open"] = true;

//    defConfig["menuElements"][6]["name"] = "Частотний план";
//    defConfig["menuElements"][6]["open"] = true;

    defConfig["menuElements"][6]["name"] = "Дисплей";
    defConfig["menuElements"][6]["open"] = true;
    ...
    defConfig["moduleInstances"]["Malva Server Source"]["module"] = "sdrpp_server_source";
    defConfig["moduleInstances"]["Malva Server Source"]["enabled"] = true;
    ...
    defConfig["streams"]["Канал приймання"]["sink"] = "Аудіо";
    defConfig["streams"]["Канал приймання"]["volume"] = 1.0f;
